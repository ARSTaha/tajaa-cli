...
class TestInputValidator(unittest.TestCase):
    ...
    def test_validate_port_boundary(self):
        ...
        is_valid, error, port_num = self.validator.validate_port("1")
        self.assertTrue(is_valid)

        # Test maximum valid port
        is_valid, error, port_num = self.validator.validate_port("65535")
        self.assertTrue(is_valid)

        # Test just below minimum
        is_valid, error, port_num = self.validator.validate_port("0")
        self.assertFalse(is_valid)

        # Test just above maximum
        is_valid, error, port_num = self.validator.validate_port("65536")
        self.assertFalse(is_valid)
